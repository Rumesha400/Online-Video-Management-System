...
class YouTubeManager {
     ...
     Hashtable<String, ArrayList<Video>> videoCategories = new Hashtable<>();
    ...
    public void saveVideosToFile(String fileName) throws IOException {
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        manager.addVideo(new Video(title, desc));
